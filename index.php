...
<body>
    <div id="d1">
        <img src="./imgs/Logos Coletivo Casulo-05.png" alt="logo-horizontal" id="logo-w-d1">
        <div class="scroll-d1">
            <p class="info">Role a página</p>
            <img src="./imgs/Arrow-D1.png" alt="" id="icon-d1">
        </div>
    </div>
    ...
    <div class="d2">
        <div class="div1-d2">
            <h1 class="titulo"> A corrente do pensamento!</h1>
            <hr id="palito-d2">
            <p class="frase-d2">(...) O fato de uma multidão de seres humanos seja conduzida a pensar coerentemente e de
            ...
            <button class="botao-d2">Saiba Mais!</button>
        </div>
    </div>
